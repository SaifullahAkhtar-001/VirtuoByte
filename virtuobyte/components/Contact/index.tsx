...
const index: React.FC = () => {
    return (
        <div className='flex flex-col items-center  gap-8 '>
            <div className='text-[34px] my-[1rem] text-center font-[500] break-words' >Have Questions? Contact Us</div>
