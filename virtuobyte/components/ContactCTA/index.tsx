        ...
        <div className="flex flex-col gap-[1.5rem] justify-between border dark:border-white border-black rounded-xl max-[425px]:p-4   p-6 flex-1">
            ...
            <div className='flex flex-col gap-4 '>
                <div className="text-[16px] word-break">
                    At VirtuoByte, we&apos;re committed to providing you with a seamless experience. We understand that sometimes you may not find the exact service you&apos;re looking for on our website, but fret not! Your satisfaction is our priority, and we&apos;re here to help.
                    <br />
                ...
                <Link href={'#contact'} className='p-2 w-[120px] text-center border hover:border-gray-500  dark:hover:border-gray-500 duration-300 transition ease-in-out rounded-xl border-black  dark:border-white'>Contact Us!</Link>
            </div>
        </div>
    )
}
