...
const Skills: React.FC = () => {
  ...
  return (
    <div ref={refContainer} className=' dark:text-white text-black'>
      <div className='min-h-screen  flex flex-col justify-center items-center text-[3rem] max-[782px]:text-[1.5rem] max-[500px]:text-[28px] my-[6rem] min-[10000px]:m-8 tracking-wide font-[600]'>
