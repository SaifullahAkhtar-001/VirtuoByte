...
const Index: React.FC = () => {
  ...
  return (
    <motion.div style={{opacity}}  id='top' ref={targetRef} className='flex min-[1201px]:items-center max-[1200px]:mt-[4rem]  gap-4 justify-between min-h-screen max-[1600px]:flex-col '>
